...
@section('page-content')
    <div class="mx-auto max-w-5xl pt-16 lg:pt-0">
        <section class="soft-card relative overflow-hidden p-7 md:p-10">
            ...
            <img src="{{ asset('assets/backgrounds/bg-doodle-stars.svg') }}" alt="" aria-hidden="true"
                class="absolute right-0 top-0 w-96 opacity-35">

            <img src="{{ asset('assets/backgrounds/bg-yellow-blob.svg') }}" alt="" aria-hidden="true"
                class="absolute -bottom-16 -left-12 w-80 opacity-50">

            <div class="relative z-10">

                <div
                    class="inline-flex items-center gap-2 rounded-full bg-indigo-50 px-4 py-2 text-sm font-black text-indigo-700">
                ...
                <p class="mt-4 max-w-2xl text-base font-medium leading-relaxed text-slate-500">
                    Fill in the following details so the system can recommend courses based on your major, initial skill
                ...
                <form action="{{ route('preferences.store') }}" method="POST" class="mt-9 space-y-6" novalidate>
                    ...
                    <div>
                        ...
                        <input id="major" name="major" type="text" value="{{ old('major') }}"
                            placeholder="Contoh: Teknik Informatika" class="input-modern mt-2"
                            ...
                            <div x-show="open" x-transition @click.outside="open = false"
                                ...
                                <template x-for="opt in options" :key="opt.value">
                                    <button type="button" @click="select(opt.value)"
                                        :class="selected === opt.value ? 'bg-indigo-50' : 'hover:bg-slate-50'"
                    ...
                    <div>
                        ...
                        <textarea id="interest" name="interest" rows="5" placeholder="Contoh: AI, Machine Learning, Data Science"
                            class="input-modern mt-2 resize-none">{{ old('interest') }}</textarea>
                        @error('interest')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                    </div>
    ...
    <div id="loading-overlay" class="fixed inset-0 z-999 hidden items-center justify-center bg-white/60 backdrop-blur-md"
        ...
        <div class="flex flex-col items-center gap-6 px-6 text-center">
            ...
            <div class="relative flex h-28 w-28 items-center justify-center">
                ...
                <svg class="absolute inset-0 h-full w-full animate-spin" viewBox="0 0 100 100" fill="none">
                    ...
                    <circle cx="50" cy="50" r="44" stroke="url(#ring-grad)" stroke-width="8"
                        stroke-linecap="round" stroke-dasharray="138 138" stroke-dashoffset="104" />
                    <defs>
                ...
                {{-- Centre sparkle --}}
                <div
                    class="flex h-16 w-16 items-center justify-center rounded-full bg-indigo-600 shadow-lg shadow-indigo-300">
            ...
            <p id="loading-status"
                class="min-h-6 text-sm font-semibold text-indigo-600 transition-opacity duration-500"></p>
