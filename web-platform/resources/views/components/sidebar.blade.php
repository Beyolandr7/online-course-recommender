...
<aside class="fixed inset-y-0 left-0 z-40 hidden w-[230px] border-r border-indigo-100 bg-white/80 px-4 py-5 backdrop-blur-xl lg:flex flex-col justify-between">
    <div>
    ...
    <div class="pt-4 border-t border-indigo-50">
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit" class="flex w-full items-center gap-3 rounded-2xl px-3.5 py-3 text-sm font-extrabold text-rose-600 hover:bg-rose-50 hover:text-rose-700 transition cursor-pointer">
